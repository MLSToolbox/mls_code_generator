...
Construye y ejecuta el contenedor Docker del code generator para el ambiente especificado.
...
# Solo exponer puerto si EXTERNAL_PORT está definido
if [ -n "$EXTERNAL_PORT" ]; then
    PORT_ARG="-p ${EXTERNAL_PORT}:${PORT}"
else
    PORT_ARG=""
fi
...
echo ""
echo "=========================================="
echo "✅ COMPLETADO - Code Generator corriendo"
echo "=========================================="
echo "Ambiente: $ENVIRONMENT"
[ -n "$EXTERNAL_PORT" ] && echo "Acceso: http://localhost:$EXTERNAL_PORT"
echo "Contenedor: $CONTAINER_NAME"
echo "=========================================="
